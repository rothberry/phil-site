...
const ContextProvider = (props) => {
	...
	const links = {
		...
		resume:
			"https://docs.google.com/document/d/e/2PACX-1vSh1Sg90IJq74oInKebwjaz5E_Dx4IzqqJ7fwOmAbmj6HpYDt6yDaCPMTPHsmLoYjRoopmqqy9T7UkP/pub?embedded=true",
		...
		pyTermLiveApp: "https://pypi.org/project/py-term-helpers/",
		pyTermGit: "https://github.com/rothberry/py-term-helpers",
	}
	...
	const projectDetails = {
		...
		pyTermHelpers: {
			name: "py-term-helpers",
			desc: "A simple published python package to help users debug their code in terminal with useful print outputs",
		},
		retroJS: {
			name: "RetroJS",
...
>>>>>>> 71149e7633d1d0e301298008949627d0ab908def
